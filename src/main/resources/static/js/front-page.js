...
$(document).ready(async() => {
  ...
  $('#navbarMenu').on('click', async(event) => {
    await handleChangeNavBar(event, '#myAccountBtn', '/html/f-user_info.html');
    await handleChangeNavBar(event, '#applyListBtn', '/html/f-user_info.html');
    await handleChangeNavBar(event, '#backManageBtn', '/html/f-user_info.html');
  })
});